...
public class FileController {
    ...
    public ResponseEntity<ResUploadFileDTO> upload(
        ...
        // validate
        if (file.isEmpty() || file == null) throw new FileUploadException("File is emty.Let upload a file");
        String fileName = file.getOriginalFilename();
        List<String> allowedExtensions = Arrays.asList("pdf", "jpg", "jpeg", "png", "doc", "docx");
        boolean isValidExtension = allowedExtensions.stream()
                .anyMatch(ext -> fileName.toLowerCase().endsWith("." + ext));
        if (!isValidExtension)
            throw new FileUploadException("File type is not allowed. Only allows: " + allowedExtensions.toString());
